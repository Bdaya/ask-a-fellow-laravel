    ...
    <div class="container" >
        ...
        <div class=".col-sm-4 col-md-4">
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo e(url('/howitworks')); ?>">How it works</a>
                </li>
            </ul>
        </div>
        <div class=".col-sm-4 col-md-4">
            <ul>
                <li>
                    <a href="<?php echo e(url('/browse')); ?>">Browse Courses</a>
                </li>
                <li>
...
<div id="rights">
    ...
    <br>
    <a target="_blank" href="https://www.facebook.com/BdayaNGO"><img class="contact_logo" src="<?php echo e(asset('/art/facebook.png')); ?>"></a>
    <a target="_blank" href="https://www.youtube.com/user/salfoosh"><img class="contact_logo" src="<?php echo e(asset('/art/youtube.png')); ?>"></a>
    <a target="_blank" href="https://www.instagram.com/bdaya_ngo/"><img class="contact_logo" src="<?php echo e(asset('/art/instagram.png')); ?>"></a>
    <a target="_blank" href="https://github.com/AyaKhaled1/ask-a-fellow-laravel/"><img class="contact_logo" src="<?php echo e(asset('/art/github.png')); ?>"></a>
</div>
    ...
    <div class="modal-dialog">
        <div class=""  style="background-color:rgba(255,255,255,0.8)">
            ...
            <div class="modal-body" style="padding: 0 50px 40px 50px;">
                <h3>Send Feedback </h3>
                <form method="post" action="<?php echo e(url('/feedback')); ?>">
